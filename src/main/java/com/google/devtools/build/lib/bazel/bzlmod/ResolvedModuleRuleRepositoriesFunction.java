...
public class ResolvedModuleRuleRepositoriesFunction implements SkyFunction {

  @Nullable
  @Override
  public SkyValue compute(SkyKey skyKey, Environment env)
      throws SkyFunctionException, InterruptedException {
    Preconditions.checkArgument(skyKey == ResolvedModuleRuleRepositoriesValue.key());
    ...
    return new ResolvedModuleRuleRepositoriesValue(
