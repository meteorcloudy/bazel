...
public class ResolvedBazelModuleRepositoriesFunction implements SkyFunction {

  @Nullable
  @Override
  public SkyValue compute(SkyKey skyKey, Environment env)
      throws SkyFunctionException, InterruptedException {
    Preconditions.checkArgument(skyKey == ResolvedBazelModuleRepositoriesValue.key());
    ...
    return new ResolvedBazelModuleRepositoriesValue(
