...
public final class RepositoryDelegatorFunction implements SkyFunction {
  ...
  public SkyValue compute(SkyKey skyKey, Environment env)
    ...
    if (!repositoryName.isVisible()) {
      String workspaceDeprecationMsg = externalPackageHelper.getWorkspaceDeprecationErrorMessage(env, starlarkSemantics.getBool(BuildLanguageOptions.ENABLE_WORKSPACE), repositoryName.isOwnerRepoMainRepo());
      ...
      return new NoRepositoryDirectoryValue(
          String.format(
              ...
              repositoryName.getName(), repositoryName.getOwnerRepoDisplayString(), workspaceDeprecationMsg));
    }
