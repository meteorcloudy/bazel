...
public class PackageLookupFunction implements SkyFunction {
  ...
  public SkyValue compute(SkyKey skyKey, Environment env)
    ...
    if (!repoName.isVisible()) {
      String workspaceDeprecationMsg = externalPackageHelper.getWorkspaceDeprecationErrorMessage(env, semantics.getBool(BuildLanguageOptions.ENABLE_WORKSPACE), repoName.isOwnerRepoMainRepo());
