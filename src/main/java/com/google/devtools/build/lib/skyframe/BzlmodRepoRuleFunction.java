...
import com.google.devtools.build.lib.bazel.bzlmod.BzlmodRepoRuleValue.Key;
import com.google.devtools.build.lib.bazel.bzlmod.RepoSpec;
import com.google.devtools.build.lib.bazel.bzlmod.RepoSpecsValue;
...
public class BzlmodRepoRuleFunction implements SkyFunction {
  ...
  private BzlmodRepoRuleValue getNativeRepoRule(
    ...
    RuleClass ruleClass = ruleClassProvider.getRuleClassMap().get(repoSpec.getRuleClassName());
  ...
  private BzlmodRepoRuleValue getStarlarkRepoRule(
    ...
    ImmutableList<Pair<String, Location>> programLoads =
        ImmutableList.of(Pair.of(repoSpec.getBzlFile(), Location.BUILTIN));
    ...
    Object o = loadedModules.get(repoSpec.getBzlFile()).getGlobal(repoSpec.getRuleClassName());
